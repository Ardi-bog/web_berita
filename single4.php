<?php
	...
	$tampil = mysqli_fetch_array(mysqli_query($koneksi,"select * from trending1 where id_berita = '$getberita'"));
?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<p><b><i><?php
                                    include "koneksi.php";
                                    $query = mysqli_query($koneksi,"SELECT * FROM komentar4");
...
include "koneksi.php";
?>
<?php $ambil = $koneksi -> query("select*from komentar4 order by id_komentar DESC");?>
...
?>
						...
						<div class="reply_form_container">
							<div class="reply_form_title">Leave a reply</div>
							 <form action= "proses_submit5.php"method="POST">
...
<?php $ambil = $koneksi -> query("select*from late1 order by id_berita DESC");?>
<?php while($tampil = $ambil -> fetch_assoc()){?>
							...
							<div class="latest_posts">
								...
								<div class="latest_post d-flex flex-row align-items-start justify-content-start">
									...
									<div class="latest_post_content">
										...
										<div class="latest_post_title"><a href="single5.php?id_berita=<?php echo $tampil['id_berita']; ?>"><?php echo $tampil['judul_berita'];?></a></div>
