<?php
	...
	$tampil = mysqli_fetch_array(mysqli_query($koneksi,"select * from late1 where id_berita = '$getberita'"));
?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div class="col-lg-9">
					...
					<div class="single_post">
						...
						<!-- Reply  -->
											<p><b><i><?php
                                    include "koneksi.php";
                                    $query = mysqli_query($koneksi,"SELECT * FROM komentar5");
...
include "koneksi.php";
?>
<?php $ambil = $koneksi -> query("select*from komentar5 order by id_komentar DESC");?>
...
?>
						...
						<div class="reply_form_container">
							<div class="reply_form_title">Leave a reply</div>
							 <form action= "proses_submit6.php"method="POST">
