        ...
        <div class="row">
          <div class="col">
            <div class="section_title_container d-flex flex-row align-items-start justify-content-start">
              <div>
                <div class="section_title">Olahraga</div>
...
include "koneksi.php";
?>
<?php $ambil = $koneksi -> query("select*from upload where kategori='Olahraga' order by id_berita DESC ");?>
<?php while($tampil = $ambil -> fetch_assoc()){?>
                  ...
                  <div class="post_item post_v_large d-flex flex-column align-items-start justify-content-start">
                    ...
                    <div class="post_content">
                      ...
                      <div class="post_title"><a href="page.php?id_berita=<?php echo $tampil['id_berita']; ?> "><label><?php echo $tampil['judul_berita'];?></label></a></div>
                      <div class="post_info d-flex flex-row align-items-center justify-content-start">
                        <div class="post_author d-flex flex-row align-items-center justify-content-start">
                          <div class="post_author_name"><?php echo $tampil['nama'];?><a href="#"></a></div>
                        </div>
                        <div class="post_date"><a href="#"></a></div>
                        <div class="post_comments ml-auto"><a href="#"><?php echo $tampil['tgl'];?></a></div>
                      </div>
                      <div class="post_text">
...
?>
            ...
            <div class="technology">
              <div class="section_title_container d-flex flex-row align-items-start justify-content-start">
                <div>
                  <div class="section_title">Teknologi</div>
                  <div class="section_subtitle"></div>
                </div>
                <div class="section_bar"></div>
              </div>
...
<?php $ambil = $koneksi -> query("select*from upload where kategori='Teknologi' order by id_berita DESC ");?>
<?php while($tampil = $ambil -> fetch_assoc()){?>
                ...
                <div class="post_item post_h_large">
                  <div class="row">
                    ...
                    <div class="col-lg-7">
                      <div class="post_content">
                        <div class="post_category cat_technology"><a href="category.html">Teknologi</a></div>
                        <div class="post_title"><a href="page.php?id_berita=<?php echo $tampil['id_berita']; ?>"><label><?php echo $tampil['judul_berita'];?></label></a></div>
                        <div class="post_info d-flex flex-row align-items-center justify-content-start">
                          <div class="post_author d-flex flex-row align-items-center justify-content-start">
                            <div><div class="post_author_image"><img src="images/author_1.jpg" alt=""></div></div>
                            <div class="post_author_name"><a href="#"><?php echo $tampil['nama'];?></a></div>
                          </div>
                          <div class="post_date"><a href="#"><?php echo $tampil['tgl'];?></a></div>
                        </div>
                        <div class="post_text">
                          <p><?php echo $tampil['deskripsi'];?></p>
                        </div>
        ...
        <div class="col-lg-3">
          <div class="sidebar">
            ...
            <div class="sidebar_latest">
              <div class="sidebar_title">Politik</div>
              <div class="latest_posts">
<?php
include "koneksi.php";
?>

<?php $ambil = $koneksi -> query("select*from upload where kategori ='Politik'order by id_berita DESC");?>
<?php while($tampil = $ambil -> fetch_assoc()){?>
                ...
                <div class="latest_post d-flex flex-row align-items-start justify-content-start">
                  ...
                  <div class="latest_post_content">
                    ...
                    <div class="latest_post_title"><a href="page.php?id_berita=<?php echo $tampil['id_berita']; ?>"><label><?php echo $tampil['judul_berita'];?></label></a></div>
                    <div class="latest_post_date"><?php echo $tampil['tgl'];?></div>
                  </div>
                </div>
<?php
}
?>
            ...
            <div class="tags">
              ...
              <div class="tags_content d-flex flex-row align-items-start justify-content-start flex-wrap">
                <div class="tag cat_technology"><a href="konten.php">Technology</a></div>
                <div class="tag cat_video"><a href="sport.php">Sport</a></div>
                <div class="tag cat_party"><a href="politic.php">Politic</a></div>
              </div>
            </div>
