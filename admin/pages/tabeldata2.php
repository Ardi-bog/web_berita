            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="berita2.php"><i class="fa fa-table fa-fw"></i> Tambah Berita Politik</a>
                        </li>
                        
                        <li>
                            <a href="berita3.php"><i class="fa fa-table fa-fw"></i> Tambah Berita Selebriti</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="tabeldata2.php"><i class="fa fa-table fa-fw"></i> Manage Data Politik</a>
                        </li>
                        <li>
                            <a href="tabeldata3.php"><i class="fa fa-table fa-fw"></i> Manage Data Selebriti</a>
                        </li>
						<li>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
									...
									<?php
										include"koneksi.php";
										$query = "SELECT * FROM berita2 order by id_berita DESC";
