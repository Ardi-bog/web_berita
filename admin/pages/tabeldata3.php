                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
									...
									<?php
										include"koneksi.php";
										$query = "SELECT * FROM berita3 order by id_berita DESC";
                                ...
                                <tbody>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><a href="edit2.php?id=<?php echo $tampil['id_berita']; ?>">Edit</a></td>
                                        <td><a href="delete4.php?id=<?php echo $tampil['id_berita']; ?>" onclick="return confirm('Apakah anda yakin Menghapus Ini?')">Delete</a></td>
                                    </tr>
                                   <?php
										}
									?>
