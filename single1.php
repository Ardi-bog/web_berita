<?php
	...
	$tampil = mysqli_fetch_array(mysqli_query($koneksi,"select * from trending where id_berita = '$getberita'"));
?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<p><b><i><?php
                                    include "koneksi.php";
                                    $query = mysqli_query($koneksi,"SELECT * FROM komentar1");
...
include "koneksi.php";
?>
<?php $ambil = $koneksi -> query("select*from komentar1 order by id_komentar DESC");?>
...
?>
						...
						<div class="reply_form_container">
							<div class="reply_form_title">Leave a reply</div>
							 <form action= "proses_submit2.php"method="POST">
