<?php
	...
	$tampil = mysqli_fetch_array(mysqli_query($koneksi,"select * from late3 where id_berita = '$getberita'"));
?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div class="col-lg-9">
					...
					<div class="single_post">
						...
						<!-- Comments -->
								...
								<p><b><i><?php
                                    include "koneksi.php";
                                    $query = mysqli_query($koneksi,"SELECT * FROM komentar8");
...
include "koneksi.php";
?>
<?php $ambil = $koneksi -> query("select*from komentar8 order by id_komentar DESC");?>
...
?>
						...
						<div class="reply_form_container">
							<div class="reply_form_title">Leave a reply</div>
							 <form action= "proses_submit9.php"method="POST">
