                ...
                <ul class="main_nav_list d-flex flex-row align-items-center justify-content-start">
                 ...
                 <li><a href="user_upload.php">Upload Beritamu</a></li>
							...
							<div class="header_search_container ml-auto">
								...
								<form action="search_proses.php" id="header_search_form" method="POST"  class="header_search_form d-flex flex-row align-items-center justfy-content-start">
										<div><div class="header_search_activation"><i class="fa fa-search" aria-hidden="true"></i></div></div>
										<input type="text" class="header_search_input" name="cari"  placeholder="Search" required="required">
									</form>									
								</div>
							</div>
...
include "koneksi.php";
?>
<?php $ambil = $koneksi -> query("select*from berita where kategori='Terbaru' order by id_berita DESC");?>
...
<?php $ambil = $koneksi -> query("select*from berita where kategori='Lainnya' order by id_berita DESC");?>
<?php while($tampil = $ambil -> fetch_assoc()){?>
								...
								<div class="post_item post_h_large">
									<div class="row">
										...
										<div class="col-lg-7">
											<div class="post_content">
												<div class="post_category cat_technology"><a href="category.html">Olahraga</a></div>
												<div class="post_title"><a href="single.php?id_berita=<?php echo $tampil['id_berita']; ?>"><label><?php echo $tampil['judul_berita'];?></label></a></div>
												<div class="post_info d-flex flex-row align-items-center justify-content-start">
													<div class="post_author d-flex flex-row align-items-center justify-content-start">
...
<?php $ambil = $koneksi -> query("select*from berita where kategori = 'Lama' order by id_berita DESC");?>
<?php while($tampil = $ambil -> fetch_assoc()){?>
								...
								<div class="latest_post d-flex flex-row align-items-start justify-content-start">
									...
									<div class="latest_post_content">
										<div class="post_category_small cat_video"><a href="category.html">Olahraga</a></div>
										<div class="latest_post_title"><a href="single.php?id_berita=<?php echo $tampil['id_berita']; ?>"><label><?php echo $tampil['judul_berita'];?></label></a></div>
...
?>
						...
						<div class="tags">
							...
							<div class="tags_content d-flex flex-row align-items-start justify-content-start flex-wrap">
								...
								<div class="tag cat_video"><a href="Olahraga.php">Olahraga</a></div>
