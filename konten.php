...
include "koneksi.php";
?>
<?php $ambil = $koneksi -> query("select*from berita1 where kategori='Terbaru'order by id_berita DESC");?>
<?php while($tampil = $ambil -> fetch_assoc()){?>
									<!-- Post -->
									<div class="post_item post_v_large d-flex flex-column align-items-start justify-content-start">
										<div class="post_image"><img src="admin/upload/<?php echo $tampil['gambar_berita'];?>" ></div>
										<div class="post_content">
											<div class="post_category cat_technology"><a href="">Teknologi</a></div>
											<div class="post_title"><a href="single3.php?id_berita=<?php echo $tampil['id_berita']; ?> "><label><?php echo $tampil['judul_berita'];?></label></a></div>
...
<?php $ambil = $koneksi -> query("select*from berita1 where kategori='Lainnya'order by id_berita DESC");?>
<?php while($tampil = $ambil -> fetch_assoc()){?>
...
<?php $ambil = $koneksi -> query("select*from berita1 where kategori='Lama' order by id_berita DESC");?>
<?php while($tampil = $ambil -> fetch_assoc()){?>
								...
								<div class="latest_post d-flex flex-row align-items-start justify-content-start">
									...
									<div class="latest_post_content">
										<div class="post_category_small cat_video"><a href="category.html">Teknologi</a></div>
										<div class="latest_post_title"><a href="single3.php?id_berita=<?php echo $tampil['id_berita']; ?>"><label><?php echo $tampil['judul_berita'];?></label></a></div>
...
?>
						...
						<div class="tags">
							...
							<div class="tags_content d-flex flex-row align-items-start justify-content-start flex-wrap">
								...
								<div class="tag cat_video"><a href="sport.php">Olahraga</a></div>
